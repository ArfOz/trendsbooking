...
const AddNewEmployeeForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        setFormData(initialFormData); // Form verisini sıfırla
      })
      .catch((error) => {
  ...
  const handleAddWorkTimeChange = (event) => {
    const { name, value } = event.target;
            ...
            >
              ...
              >
                <TextField
                  type="text"
                  name="MorningStartAt"
                  label="Sabah Başlama Saati"
                  variant="outlined"
                  onChange={handleAddWorkTimeChange}
              ...
              >
                <TextField
                  type="text"
                  name="NightStartAt"
                  label="Öğleden Sonra Başlama Saati"
                  variant="outlined"
                  onChange={handleAddWorkTimeChange}
                ...
                <TextField
                  type="text"
                  name="NightEndAt"
                  label="Öğleden Sonra Bitiş Saati"
                  variant="outlined"
                  onChange={handleAddWorkTimeChange}
